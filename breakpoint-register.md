...
| BP4 | TECHNICAL| 2026-07-02 | Deferred: collectors/files.py needs its own module-level spec (§6) written & signed off before file-collector code | — planned; opens when we enter the files stage —                                                | open       |
