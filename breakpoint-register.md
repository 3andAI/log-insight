...
| BP5 | DECISION | 2026-07-02 | UI mock / UX sign-off before building the web app (M2 start)                                   | Architect chose: single-page (filters→histogram→results); 30s auto-refresh + pause; keyset "Load older". Spec §7 | 2026-07-02 |
