...
| BP5 | DECISION | 2026-07-02 | UI mock / UX sign-off before building the web app (M2 start)                                   | Preliminary layout prefs captured (single-page; 30s+pause; keyset paging), but this was a Q&A, NOT a browser UX review. REOPENED: real sign-off pending business review of the running UI. Code built to prefs is provisional. | open |
...
| BP8 | TECHNICAL| 2026-07-02 | §5 ambiguous: does the journald cursor advance past a parsed-but-dropped entry (missing ts)? | Architect chose option B — cursor = last *successfully parsed* entry (kept or content-dropped); no advance past a trailing unparseable line. spec §5.4 updated | 2026-07-02 |
